    ...
    print("""
            <div class="jumbotron">
              <div class="container">
                <h1>Hello, world!
                <br>
                This is a template for a simple marketing or informational website. It includes a large callout called a jumbotron and three supporting pieces of content. Use it as a starting point to 
create something more unique.</h1>
              </div>
            </div>
        """)
def blog_posts():
...
if not logged_in and session == "False":
    frontpage()
elif logout:
    write_session("False")
    logged_in = False
    ...
    settings_and_editor_nav()
    editor_body()
elif session == "True" and settings:
    settings_and_editor_nav()
    settings_body()
else:
    frontpage()
